...
public class TreeAVLMapTest {
    ...
    @Test
    void whenRemoveLastElementThenEmpty() {
        TreeAVLMap<Integer, String> tree = new TreeAVLMap<>();
        tree.put(1, "11");
    ...
    @Test
    void whenMultipleOperationsThenMaintainOrder() {
        TreeAVLMap<Integer, String> tree = new TreeAVLMap<>();
        tree.put(10, "ten");
        tree.put(20, "twenty");
        tree.put(5, "five");
        tree.put(15, "fifteen");
        tree.remove(20);
        assertThat(tree.keySet()).containsExactly(5, 10, 15);
        assertThat(tree.values()).containsExactly("five", "ten", "fifteen");
    }
}